        ...
        <div className="flex flex-wrap items-start justify-between gap-8">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <Link href="#" className="w-8 h-8 rounded-full flex items-center justify-center hover:opacity-80 overflow-hidden" aria-label="Facebook">
              ...
              <Link href="#" className="w-8 h-8 flex items-center justify-center hover:opacity-80" aria-label="Google">
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="white">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </Link>
              <Link href="#" className="w-8 h-8 flex items-center justify-center hover:opacity-80" aria-label="Instagram">
                <svg className="w-8 h-8" viewBox="0 0 24 24">

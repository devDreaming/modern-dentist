...
const cards = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-8 h-8" aria-hidden="true">
            ...
            if (index === 1) {
              return (
                <button
                  ...
                  className={className}
                  style={style}
                  aria-label="Convenient Appointments — Flexible scheduling to fit your busy life"
                >
                  {content}
                </button>
              );
